            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <tr>
							<input  disabled type="text" name ="student_id" value="<?=$student['id']; ?>">
							
				<td width="270px">SURNAME:</td>
			 <td><input size="45px"  disabled type="text" name="lname" value= "<?=$student ['lname'];?>" autofocus="autofocus" required></td> 
             

				<td>UPLOAD PHOTO:</td>
				<td> <input type="file"  disabled name="image" id ="image" accept=".jpg, .jpeg, .png" value= "<?=$student ['image'];?>"> 
        <img src = "<?php echo "upload/".$student['image']; ?>" width="100px;" height="100px;"></td>

			</tr>
			<tr>
				<td>FIRST NAME:</td>
				<td><input size="45px" disabled  type="text" name="fname" value= "<?=$student ['fname'];?>"></td>

				<td>NAME EXTENSION(jr,sr):</td>
				<td><input size="20px" disabled type="text" name="NameEx" value= "<?=$student ['NameEx'];?>"></td>
			</tr>

				<td>MIDDLE NAME:</td>
				<td><input size="45px"disabled  type="text" name="mname" value= "<?=$student ['mname'];?>">
				</td>

				<td>UPLOAD FILE:</td>
        <td>
        <input disabled type="input"class="form-control-file" name="pds" id="exampleFormControlFile1" value= "<?=$student ['pds'];?> ">
          <input disabled type="file" name="pds" class="form-control-file" id="exampleFormControlFile1" >
                            </td>
			</tr>
			...
			<tr>
				...
				<td><input disabled size="45px" type="text" name="Gender" value= "<?=$student ['Gender'];?>"> </td>
</hr>
</tr>
<tr>
	<td>Citizenship</td>
	...
	<input disabled size="17px" type="text" id="DDL" disabled="disabled" value="No" name="cship" value= "<?=$student ['cship'];?> " />
	   </td>
	   </tr>
	<tr>

				<td>DATE OF BIRTH:</td>
				<td><input disabled  size="45px" type="text" name="date" value= "<?=$student ['date'];?> "></td>
        ...
        <td><input disabled size="32px" type="text" placeholder="Street" name="street" value= "<?=$student ['street'];?> "></td>
			...
			<tr>
				<td>AGE:</td>
				<td><input disabled  size="45px" type="text" name="age" value= "<?=$student ['age'];?> "></td>
			...
			<tr>
			<td>CIVIL STATUS</td>
				<td><input disabled size="45px" type="text" name="cstatus" value= "<?=$student ['cstatus'];?> "></td>
			...
			<tr>
				<td>HEIGHT(cm):</td>
				<td><input disabled  size="45px " type="text" name="Height" value= "<?=$student ['Height'];?> "></td>     		
			</tr>
			<tr>
				<td>WEIGHT(kg):</td>
				<td><input disabled size="45px " type="text" name="Weight" value= "<?=$student ['Weight'];?> "></td>
           ...
           <td><input disabled type="radio" value="Click if your permanent address is same with Residential"
			...
			<tr>
				<td>BLOODTYPE:</td>
				<td><input  disabled size="45px "  type="text" name="Btype" value= "<?=$student ['Btype'];?> "></td>
			
			</tr>
			<tr>
				<td>GSIS NO.:</td>
				<td><input disabled size="45px " type="text" name="GSIS" value= "<?=$student ['GSIS'];?> "></td>
			...
			<tr>
				<td>PAG-IBIG NO.:</td>
				<td><input disabled size="45px" type="text" name="PagIbig" value= "<?=$student ['PagIbig'];?> "></td>
			...
			<tr>
				<td>PHILHEALTH NO.:</td>
				<td><input disabled size="45px" type="text" name="Phealth" value= "<?=$student ['Phealth'];?> "></td>
			...
			<tr>
				<td>SSS NO.:</td>
				<td><input disabled size="45px" type="text" name="SSS" value= "<?=$student ['SSS'];?> "></td>
			...
			<tr>
				<td>TIN NO.:</td>
				<td><input disabled size="45px" type="text" name="Tin" value= "<?=$student ['Tin'];?> "></td>
			</tr>
			<tr>
				<td>AGENCY EMPLOYEE NO.:</td>
				<td><input disabled size="45px" type="text" name="user_id" value= "<?=$student ['user_id'];?> "></td>
			</tr>
          </table>
</br>
<div class="mb-3">
