...
$query1 = mysqli_query($conn,"select * from tbl_family where user_id = '$id'");
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><center>Employee Details 
                          ...
                          <a href="user_index3.php" class="btn btn-secondary float-end">NEXT</a>
    ...
    for($i=1; $i<=$result;$i++)
{
 	...
 	?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="user_employee-fambg-view.php?id=<?= $row['id']; ?>" class="btn btn-info btn-sm">View</a>
