...
$query1 = mysqli_query($conn,"select * from tbl_upload where user_id = '$id'");
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4><center>Employee Details <a href="user_index2.php" class="btn btn-secondary float-end">NEXT</a>
    ...
    for($i=1; $i<=$result;$i++)
{
 	...
 	?>
                                            <tr  height="20%">
                                                ...
                                                <td> <img src="<?php echo "upload/" .$row["image"]; ?>" width = 100 height = 100 alt="Image"> </td>
                                                <td><?= $row['fname']; ?></td>
                                                <td><?= $row['lname']; ?></td>
                                                <td><?= $row['mname']; ?></td>
                                                <td>
                                                <a href="user_employee-view.php?id=<?= $row['id']; ?>" class="btn btn-info btn-sm">View</a>
                                            </tr>
                                            <?php } ?> 
                    </div>
                </div>
